...
- `StockReviewFooterRenderer` / `StockReviewFooterSpec` / `StockReviewFooterButtonSet`: footer layout, explicit footer button-set selection, and mode-specific footer button definitions.
