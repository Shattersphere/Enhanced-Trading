...
- `tools/validate-runtime-evidence-contracts.ps1` proves evidence-helper skip/fail-closed behavior, analyzer wiring, and malformed rollback-record rejection; it does not create runtime evidence.
