...
- `tools/validate-runtime-evidence-contracts.ps1` proves evidence-helper skip/fail-closed behavior, analyzer wiring, malformed rollback-record and ship-summary rejection, and required expected-hull checks; it does not create runtime evidence.
