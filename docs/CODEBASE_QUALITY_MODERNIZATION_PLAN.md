...
Static/build/package: `build.ps1`, `validateLocalBuildEnvironment`, Kotlin/GUI/jar/compat/assertion/config/Fixer/rollback/source/ship/evidence validators, doc links, `export-public.ps1`, `git diff --check`, deploy parity/evidence.
