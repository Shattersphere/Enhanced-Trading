...
enum class StockReviewActionGroup(
    ...
    NAVIGATION(
        ...
        StockReviewAction.Type.OPEN_AUTO_RULES,
    ),
    AUTO_RULES(
        "auto-rules controls",
        ...
        StockReviewAction.Type.AUTO_RULES_CYCLE_TAB,
        StockReviewAction.Type.AUTO_RULES_CYCLE_HELD_FILTER,
        StockReviewAction.Type.AUTO_RULES_CYCLE_RULE_FILTER,
        StockReviewAction.Type.AUTO_RULES_CYCLE_NEW_FILTER,
        StockReviewAction.Type.AUTO_RULES_CYCLE_SIZE_FILTER,
        StockReviewAction.Type.AUTO_RULES_CYCLE_DAMAGE_FILTER,
        StockReviewAction.Type.AUTO_RULES_CYCLE_DESIGN_TYPE_FILTER,
        StockReviewAction.Type.AUTO_RULES_COMMIT_NAME_QUERY,
        StockReviewAction.Type.AUTO_RULES_ADJUST_SELL_ABOVE,
        StockReviewAction.Type.AUTO_RULES_ADJUST_BUY_BELOW,
        StockReviewAction.Type.AUTO_RULES_CLEAR_RULE,
        StockReviewAction.Type.AUTO_RULES_TOGGLE_SELECT_ITEM,
        StockReviewAction.Type.AUTO_RULES_TOGGLE_SELECT_ALL_VISIBLE,
        StockReviewAction.Type.AUTO_RULES_APPLY_BULK,
        StockReviewAction.Type.AUTO_RULES_CLEAR_SELECTED,
        StockReviewAction.Type.AUTO_RULES_TOGGLE_HULLMOD_BLACKLIST,
    ),
    ;
