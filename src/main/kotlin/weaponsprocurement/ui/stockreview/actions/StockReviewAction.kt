...
class StockReviewAction private constructor(
    ...
    companion object {
        ...
        fun toggle(category: StockCategory?): StockReviewAction =
            StockReviewAction(Type.TOGGLE_CATEGORY, category, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun toggle(itemType: StockItemType?, category: StockCategory?): StockReviewAction =
            StockReviewAction(Type.TOGGLE_CATEGORY, category, itemType, null, null, null, null, null, null, 0)

        @JvmStatic
        fun toggle(itemType: StockItemType?): StockReviewAction =
            StockReviewAction(Type.TOGGLE_ITEM_TYPE, null, itemType, null, null, null, null, null, null, 0)

        @JvmStatic
        fun toggle(tradeGroup: StockReviewTradeGroup?): StockReviewAction =
            StockReviewAction(Type.TOGGLE_TRADE_GROUP, null, null, tradeGroup, null, null, null, null, null, 0)

        @JvmStatic
        fun toggle(reviewItemGroup: StockReviewReviewItemGroup?): StockReviewAction =
            StockReviewAction(Type.TOGGLE_REVIEW_ITEM_GROUP, null, null, null, reviewItemGroup, null, null, null, null, 0)

        @JvmStatic
        fun toggle(filterGroup: StockReviewFilterGroup?): StockReviewAction =
            StockReviewAction(Type.TOGGLE_FILTER_GROUP, null, null, null, null, filterGroup, null, null, null, 0)
        ...
        fun adjustToSufficient(itemKey: String?, delta: Int): StockReviewAction =
            StockReviewAction(Type.ADJUST_TO_SUFFICIENT, null, null, null, null, null, null, itemKey, null, delta)

        @JvmStatic
        fun cycleSortMode(): StockReviewAction =
            StockReviewAction(Type.CYCLE_SORT_MODE, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun toggleBlackMarket(): StockReviewAction =
            StockReviewAction(Type.TOGGLE_BLACK_MARKET, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun cycleSourceMode(): StockReviewAction =
            StockReviewAction(Type.CYCLE_SOURCE_MODE, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun scrollList(delta: Int): StockReviewAction =
            StockReviewAction(Type.SCROLL_LIST, null, null, null, null, null, null, null, null, delta)

        @JvmStatic
        fun reviewPurchase(): StockReviewAction =
            StockReviewAction(Type.REVIEW_PURCHASE, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun purchaseAllUntilSufficient(): StockReviewAction =
            StockReviewAction(Type.PURCHASE_ALL_UNTIL_SUFFICIENT, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun sellAllUntilSufficient(): StockReviewAction =
            StockReviewAction(Type.SELL_ALL_UNTIL_SUFFICIENT, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun resetAllTrades(): StockReviewAction =
            StockReviewAction(Type.RESET_ALL_TRADES, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun openFilters(): StockReviewAction =
            StockReviewAction(Type.OPEN_FILTERS, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun toggleFilter(filter: StockReviewFilter?): StockReviewAction =
            StockReviewAction(Type.TOGGLE_FILTER, null, null, null, null, null, filter, null, null, 0)

        @JvmStatic
        fun resetFilters(): StockReviewAction =
            StockReviewAction(Type.RESET_FILTERS, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun openColorDebug(): StockReviewAction =
            StockReviewAction(Type.OPEN_COLOR_DEBUG, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun openShipCatalogDebug(): StockReviewAction =
            StockReviewAction(Type.OPEN_SHIP_CATALOG_DEBUG, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun debugCycleTarget(delta: Int): StockReviewAction =
            StockReviewAction(Type.DEBUG_CYCLE_TARGET, null, null, null, null, null, null, null, null, delta)

        @JvmStatic
        fun debugTogglePersistence(): StockReviewAction =
            StockReviewAction(Type.DEBUG_TOGGLE_PERSISTENCE, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun debugAdjustRed(delta: Int): StockReviewAction =
            StockReviewAction(Type.DEBUG_ADJUST_RED, null, null, null, null, null, null, null, null, delta)

        @JvmStatic
        fun debugAdjustGreen(delta: Int): StockReviewAction =
            StockReviewAction(Type.DEBUG_ADJUST_GREEN, null, null, null, null, null, null, null, null, delta)

        @JvmStatic
        fun debugAdjustBlue(delta: Int): StockReviewAction =
            StockReviewAction(Type.DEBUG_ADJUST_BLUE, null, null, null, null, null, null, null, null, delta)

        @JvmStatic
        fun debugApply(): StockReviewAction =
            StockReviewAction(Type.DEBUG_APPLY, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun debugConfirm(): StockReviewAction =
            StockReviewAction(Type.DEBUG_CONFIRM, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun debugRestore(): StockReviewAction =
            StockReviewAction(Type.DEBUG_RESTORE, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun debugNoop(): StockReviewAction =
            StockReviewAction(Type.DEBUG_NOOP, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun confirmPurchase(): StockReviewAction =
            StockReviewAction(Type.CONFIRM_PURCHASE, null, null, null, null, null, null, null, null, 0)

        @JvmStatic
        fun goBack(): StockReviewAction =
            StockReviewAction(Type.GO_BACK, null, null, null, null, null, null, null, null, 0)
    }
}
